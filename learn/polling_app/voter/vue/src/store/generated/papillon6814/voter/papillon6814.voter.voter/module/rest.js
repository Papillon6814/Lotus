...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/papillon6814/voter/voter/poll
         */
        this.queryPollAll = (query, params = {}) => this.request({
            path: `/papillon6814/voter/voter/poll`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/papillon6814/voter/voter/poll/{id}
         */
        this.queryPoll = (id, params = {}) => this.request({
            path: `/papillon6814/voter/voter/poll/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });
