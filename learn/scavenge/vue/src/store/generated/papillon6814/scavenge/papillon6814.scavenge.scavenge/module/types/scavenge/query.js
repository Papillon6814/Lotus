...
export class QueryClientImpl {
    ...
    Commit(request) {
        ...
        const promise = this.rpc.request('papillon6814.scavenge.scavenge.Query', 'Commit', data);
    ...
    CommitAll(request) {
        ...
        const promise = this.rpc.request('papillon6814.scavenge.scavenge.Query', 'CommitAll', data);
    ...
    Scavenge(request) {
        ...
        const promise = this.rpc.request('papillon6814.scavenge.scavenge.Query', 'Scavenge', data);
    ...
    ScavengeAll(request) {
        ...
        const promise = this.rpc.request('papillon6814.scavenge.scavenge.Query', 'ScavengeAll', data);
