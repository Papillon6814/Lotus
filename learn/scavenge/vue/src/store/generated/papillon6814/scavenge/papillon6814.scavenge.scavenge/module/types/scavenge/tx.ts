...
export class MsgClientImpl implements Msg {
  ...
  RevealSolution(request: MsgRevealSolution): Promise<MsgRevealSolutionResponse> {
    ...
    const promise = this.rpc.request('papillon6814.scavenge.scavenge.Msg', 'RevealSolution', data)
  ...
  CommitSolution(request: MsgCommitSolution): Promise<MsgCommitSolutionResponse> {
    ...
    const promise = this.rpc.request('papillon6814.scavenge.scavenge.Msg', 'CommitSolution', data)
  ...
  SubmitScavenge(request: MsgSubmitScavenge): Promise<MsgSubmitScavengeResponse> {
    ...
    const promise = this.rpc.request('papillon6814.scavenge.scavenge.Msg', 'SubmitScavenge', data)
