...
const baseMsgSendIbcPost: object = { sender: '', port: '', channelID: '', timeoutTimestamp: 0, title: '', contenet: '' }
...
export const MsgSendIbcPost = {
  encode(message: MsgSendIbcPost, writer: Writer = Writer.create()): Writer {
    ...
    if (message.contenet !== '') {
      writer.uint32(50).string(message.contenet)
    }
    return writer
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break
        case 6:
          message.contenet = reader.string()
          break
        default:
  ...
  fromJSON(object: any): MsgSendIbcPost {
    ...
    if (object.contenet !== undefined && object.contenet !== null) {
      message.contenet = String(object.contenet)
    } else {
      message.contenet = ''
    }
    return message
  ...
  toJSON(message: MsgSendIbcPost): unknown {
    ...
    message.contenet !== undefined && (obj.contenet = message.contenet)
    return obj
  },
  ...
  fromPartial(object: DeepPartial<MsgSendIbcPost>): MsgSendIbcPost {
    ...
    if (object.contenet !== undefined && object.contenet !== null) {
      message.contenet = object.contenet
    } else {
      message.contenet = ''
    }
    return message
...
export class MsgClientImpl implements Msg {
  ...
  SendIbcPost(request: MsgSendIbcPost): Promise<MsgSendIbcPostResponse> {
    ...
    const promise = this.rpc.request('papillon6814.lotusibc.blog.Msg', 'SendIbcPost', data)
