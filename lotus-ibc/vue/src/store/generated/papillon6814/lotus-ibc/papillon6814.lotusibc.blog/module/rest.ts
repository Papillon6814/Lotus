...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryPost = (params: RequestParams = {}) =>
    this.request<BlogQueryGetPostResponse, RpcStatus>({
      path: `/papillon6814/lotusibc/blog/post`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   */
  querySendPost = (params: RequestParams = {}) =>
    this.request<BlogQueryGetSendPostResponse, RpcStatus>({
      path: `/papillon6814/lotusibc/blog/sendPost`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   */
  queryTimedoutPost = (params: RequestParams = {}) =>
    this.request<BlogQueryGetTimedoutPostResponse, RpcStatus>({
      path: `/papillon6814/lotusibc/blog/timedoutPost`,
      method: "GET",
      format: "json",
      ...params,
    });
