...
type MsgSendIbcPost struct {
	...
	Contenet         string `protobuf:"bytes,6,opt,name=contenet,proto3" json:"contenet,omitempty"`
}
...
func (m *MsgSendIbcPost) GetContenet() string {
	if m != nil {
		return m.Contenet
	}
	return ""
...
func init() {
	proto.RegisterType((*MsgSendIbcPost)(nil), "papillon6814.lotusibc.blog.MsgSendIbcPost")
	proto.RegisterType((*MsgSendIbcPostResponse)(nil), "papillon6814.lotusibc.blog.MsgSendIbcPostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	,
}
...
func (c *msgClient) SendIbcPost(ctx context.Context, in *MsgSendIbcPost, opts ...grpc.CallOption) (*MsgSendIbcPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/papillon6814.lotusibc.blog.Msg/SendIbcPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SendIbcPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/papillon6814.lotusibc.blog.Msg/SendIbcPost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "papillon6814.lotusibc.blog.Msg",
...
func (m *MsgSendIbcPost) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Contenet) > 0 {
		i -= len(m.Contenet)
		copy(dAtA[i:], m.Contenet)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Contenet)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Title) > 0 {
...
func (m *MsgSendIbcPost) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Contenet", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Contenet = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
